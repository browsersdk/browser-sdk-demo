...
export const getUserNotices = (data?: object) => {
  return http.request<Result<Notice>>("post", "/api/notice/user-notice/my", {
    data
  });
};

export const getUserTasks = (data?: object) => {
  return http.request<Result<Notice>>("post", "/api/notice/task/my", {
    data
  });
};

export const readNotice = (data?: object) => {
  return http.request<Result<string>>("post", "/api/notice/user-notice/read", {
    data
  });
};
