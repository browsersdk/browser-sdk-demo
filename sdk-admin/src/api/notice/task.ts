...
export const getTask = (data?: object) => {
  return http.request<Result<Task>>("post", "/api/notice/task/get", {
    data
  });
};
...
export const createTask = (data?: object) => {
  return http.request<Result<Task>>("post", "/api/notice/task/create", {
    data
  });
};
...
export const updateTask = (data?: object) => {
  return http.request<Result<Task>>("post", "/api/notice/task/update", {
    data
  });
};
...
export const delTask = (data?: object) => {
  return http.request<Result<Task>>("post", "/api/notice/task/del", {
    data
  });
};
