...
export const getSysMenuPage = (data?: object) => {
  return http.request<Result<Array<SysMenu>>>("post", "/api/sys/menu/all", {
    data
  });
};
...
export const getSysMenuGrant = (data?: object) => {
  return http.request<Result<Array<SysMenu>>>("post", "/api/sys/menu/grant", {
    data
  });
};
...
export const getSysMenu = (data?: object) => {
  return http.request<Result<SysMenu>>("post", "/api/sys/menu/get", {
    data
  });
};
...
export const createSysMenu = (data?: object) => {
  return http.request<Result<SysMenu>>("post", "/api/sys/menu/create", {
    data
  });
};
...
export const updateSysMenu = (data?: object) => {
  return http.request<Result<SysMenu>>("post", "/api/sys/menu/update", {
    data
  });
};
...
export const delSysMenu = (data?: object) => {
  return http.request<Result<SysMenu>>("post", "/api/sys/menu/del", {
    data
  });
};
...
export const getApiList = (data?: object) => {
  return http.request<Result<PageResult<any>>>("post", "/api/sys/menu/apis", {
    data
  });
};
/** 绑定api */
export const setApi = (data?: object) => {
  return http.request<Result<SysMenu>>("post", "/api/sys/menu/set_apis", {
    data
  });
};
