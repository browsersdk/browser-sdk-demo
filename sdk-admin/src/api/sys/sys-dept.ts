...
export const getDeptAll = (data?: object) => {
  return http.request<Result<Array<SysDept>>>("post", "/api/sys/dept/all", {
    data
  });
};
...
export const getSysDept = (data?: object) => {
  return http.request<Result<SysDept>>("post", "/api/sys/dept/get", {
    data
  });
};
...
export const createSysDept = (data?: object) => {
  return http.request<Result<SysDept>>("post", "/api/sys/dept/create", {
    data
  });
};
...
export const updateSysDept = (data?: object) => {
  return http.request<Result<SysDept>>("post", "/api/sys/dept/update", {
    data
  });
};
...
export const delSysDept = (data?: object) => {
  return http.request<Result<SysDept>>("post", "/api/sys/dept/del", {
    data
  });
};
