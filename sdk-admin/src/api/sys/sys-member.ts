...
export const getSysMember = (data?: object) => {
  return http.request<Result<SysMember>>("post", "/api/sys/member/get", {
    data
  });
};
...
export const createSysMember = (data?: object) => {
  return http.request<Result<SysMember>>("post", "/api/sys/member/create", {
    data
  });
};
...
export const updateSysMember = (data?: object) => {
  return http.request<Result<SysMember>>("post", "/api/sys/member/update", {
    data
  });
};
...
export const delSysMember = (data?: object) => {
  return http.request<Result<SysMember>>("post", "/api/sys/member/del", {
    data
  });
};
...
export const userInTeam = (data?: object) => {
  return http.request<Result<userInTeam>>("post", "/api/sys/member/exist", {
    data
  });
};
