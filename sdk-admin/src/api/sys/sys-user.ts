...
export const getSysUser = (data?: object) => {
  return http.request<Result<SysUser>>("post", "/api/sys/user/get", {
    data
  });
};
...
export const createSysUser = (data?: object) => {
  return http.request<Result<SysUser>>("post", "/api/sys/user/create", {
    data
  });
};
...
export const updateSysUser = (data?: object) => {
  return http.request<Result<SysUser>>("post", "/api/sys/user/update", {
    data
  });
};
...
export const delSysUser = (data?: object) => {
  return http.request<Result<SysUser>>("post", "/api/sys/user/del", {
    data
  });
};

export const changePwd = (data?: object) => {
  return http.request<Result<string>>("post", "/api/sys/changePwd", {
    data
  });
};

export const getMyUserInfo = (data?: object) => {
  return http.request<Result<string>>("get", "/api/sys/myUserinfo", {
    data
  });
};

// export const getroleList = (data?: object) => {
//   return http.request<Result<string>>("post", "/api/sys/role/list", {
//     data
//   });
// };
