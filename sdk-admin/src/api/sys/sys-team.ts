...
export const getSysTeam = (data?: object) => {
  return http.request<Result<SysTeam>>("post", "/api/sys/team/get", {
    data
  });
};
...
export const createSysTeam = (data?: object) => {
  return http.request<Result<SysTeam>>("post", "/api/sys/team/create", {
    data
  });
};
...
export const updateSysTeam = (data?: object) => {
  return http.request<Result<SysTeam>>("post", "/api/sys/team/update", {
    data
  });
};
...
export const delSysTeam = (data?: object) => {
  return http.request<Result<SysTeam>>("post", "/api/sys/team/del", {
    data
  });
};
...
export const changeTeam = (data?: object) => {
  return http.request<Result<SysTeam>>("post", "/api/sys/team/change", {
    data
  });
};
