...
export const getSysApiPage = (data?: object) => {
  return http.request<Result<PageResult<SysApi>>>("post", "/api/sys/api/page", {
    data
  });
};
...
export const getSysApi = (data?: object) => {
  return http.request<Result<SysApi>>("post", "/api/sys/api/get", {
    data
  });
};
...
export const createSysApi = (data?: object) => {
  return http.request<Result<SysApi>>("post", "/api/sys/api/create", {
    data
  });
};
...
export const updateSysApi = (data?: object) => {
  return http.request<Result<SysApi>>("post", "/api/sys/api/update", {
    data
  });
};
...
export const delSysApi = (data?: object) => {
  return http.request<Result<SysApi>>("post", "/api/sys/api/del", {
    data
  });
};
