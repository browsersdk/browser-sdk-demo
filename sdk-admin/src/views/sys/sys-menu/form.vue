  ...
  >
    ...
    <el-form-item label="菜单名" prop="menuName">
      <el-input
        ...
        clearable
        placeholder="请输入菜单名 eg:menuManage"
      />
    </el-form-item>
    ...
    <el-form-item label="图标" prop="icon">
      <el-input
        ...
        clearable
        placeholder="请输入图标 eg: menu (在icon组件中存在)"
      />
    </el-form-item>
    ...
    <el-form-item label="权限" prop="permission">
      <el-input
        ...
        clearable
        placeholder="请输入权限 eg: sys:menu:list"
      />
    </el-form-item>
    ...
    <el-form-item label="前端组件路径" prop="component">
      <el-input
        ...
        clearable
        placeholder="请输入前端组件路径 eg: 1级 Layout 二级 /sys/sys-menu/index "
      />
    </el-form-item>
