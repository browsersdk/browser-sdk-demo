...
func checkPermRoleRouter(r *gin.Engine) {
	// 可根据业务需求来设置接口版本
	v := r.Group(consts.ApiRoot, middleware.TeamHandler(), middleware.JwtAppHandler(), middleware.PermTeamHandler())
