...
// @Router /api/team/user-notice/page [post]
// @Security Bearer
...
// @Router /api/team/user-notice/get [post]
// @Security Bearer
...
// @Success 200 {object} base.Resp{data=models.UserNotice} "{"code": 200, "data": [...]}"
// @Router /api/team/user-notice/create [post]
// @Security Bearer
...
// @Param data body dto.UserNoticeDto true "body"
// @Success 200 {object} base.Resp{data=models.UserNotice} "{"code": 200, "data": [...]}"
// @Router /api/team/user-notice/update [post]
// @Security Bearer
...
// @Success 200 {object} base.Resp{data=models.UserNotice} "{"code": 200, "data": [...]}"
// @Router /api/team/user-notice/del [post]
// @Security Bearer
func (e *UserNoticeApi) Del(c *gin.Context) {
	var req sdto.TeamReqIds
	if err := c.ShouldBind(&req); err != nil {
		e.Error(c, err)
		return
	}
...
// @Router /api/team/user-notice/my [post]
// @Security Bearer
...
// @Router /api/team/user-notice/read [post]
// @Security Bearer
func (e *UserNoticeApi) Read(c *gin.Context) {
	...
	if req.Key == 1 {
		if err := service.SerUserNotice.ReadUserNotice(&req, e.GetReqId(c), utils.GetTeamId(c), utils.GetAppUid(c)); err != nil {
			e.Error(c, err)
			return
		}
	}
