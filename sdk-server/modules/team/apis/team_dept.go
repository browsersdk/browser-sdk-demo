...
type TeamDeptApi struct {
	base.BaseApi
}

var ApiTeamDept = TeamDeptApi{}
...
// // @Router /api/team/dept/page [post]
// // @Security Bearer
// func (e *TeamDeptApi) QueryPage(c *gin.Context) {
...
// @Router /api/team/dept/all [post]
// @Security Bearer
func (e *TeamDeptApi) List(c *gin.Context) {
	var req dto.SysDeptGetPageReq
	if err := c.ShouldBind(&req); err != nil {
		e.Error(c, err)
		return
...
// @Success 200 {object} base.Resp{data=models.SysDept} "{"code": 200, "data": [...]}"
// @Router /api/team/dept/get [post]
// @Security Bearer
func (e *TeamDeptApi) Get(c *gin.Context) {
	var req base.ReqId
	if err := c.ShouldBind(&req); err != nil {
		e.Error(c, err)
		return
...
// @Success 200 {object} base.Resp{data=models.SysDept} "{"code": 200, "data": [...]}"
// @Router /api/team/dept/create [post]
// @Security Bearer
func (e *TeamDeptApi) Create(c *gin.Context) {
...
// @Param data body dto.SysDeptDto true "body"
// @Success 200 {object} base.Resp{data=models.SysDept} "{"code": 200, "data": [...]}"
// @Router /api/team/dept/update [post]
// @Security Bearer
func (e *TeamDeptApi) Update(c *gin.Context) {
	var req dto.SysDeptDto
	if err := c.ShouldBind(&req); err != nil {
		e.Error(c, err)
		return
...
// @Success 200 {object} base.Resp{data=models.SysDept} "{"code": 200, "data": [...]}"
// @Router /api/team/dept/del [post]
// @Security Bearer
func (e *TeamDeptApi) Del(c *gin.Context) {
	var req base.ReqIds
	if err := c.ShouldBind(&req); err != nil {
		e.Error(c, err)
		return
	...
	for _, id := range req.Ids {
		if err := service.SerSysDept.Del(id, teamId, uid); err != nil {
			e.Error(c, err)
			return
		}
	}
