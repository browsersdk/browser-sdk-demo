...
// @Router /api/notice/pub-notice/page [post]
// @Security Bearer
...
// @Router /api/notice/pub-notice/get [post]
// @Security Bearer
...
// @Success 200 {object} base.Resp{data=models.PubNotice} "{"code": 200, "data": [...]}"
// @Router /api/notice/pub-notice/create [post]
// @Security Bearer
...
// @Param data body dto.PubNoticeDto true "body"
// @Success 200 {object} base.Resp{data=models.PubNotice} "{"code": 200, "data": [...]}"
// @Router /api/notice/pub-notice/update [post]
// @Security Bearer
...
// @Success 200 {object} base.Resp{data=models.PubNotice} "{"code": 200, "data": [...]}"
// @Router /api/notice/pub-notice/del [post]
// @Security Bearer
