...
// @Router /api/notice/task/page [post]
// @Security Bearer
...
// @Router /api/notice/task/get [post]
// @Security Bearer
...
// @Success 200 {object} base.Resp{data=models.Task} "{"code": 200, "data": [...]}"
// @Router /api/notice/task/create [post]
// @Security Bearer
...
// @Param data body dto.TaskDto true "body"
// @Success 200 {object} base.Resp{data=models.Task} "{"code": 200, "data": [...]}"
// @Router /api/notice/task/update [post]
// @Security Bearer
...
// @Success 200 {object} base.Resp{data=models.Task} "{"code": 200, "data": [...]}"
// @Router /api/notice/task/del [post]
// @Security Bearer
...
// @Router /api/notice/task/my [post]
// @Security Bearer
