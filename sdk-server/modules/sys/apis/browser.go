...
// @Router /api/sys/browser/page [post]
// @Security Bearer
...
// @Router /api/sys/browser/get [post]
// @Security Bearer
...
// @Success 200 {object} base.Resp{data=models.Browser} "{"code": 200, "data": [...]}"
// @Router /api/sys/browser/create [post]
// @Security Bearer
...
// @Param data body dto.BrowserDto true "body"
// @Success 200 {object} base.Resp{data=models.Browser} "{"code": 200, "data": [...]}"
// @Router /api/sys/browser/update [post]
// @Security Bearer
func (e *BrowserApi) Update(c *gin.Context) {
	...
	var data models.Browser
	copier.Copy(&data, req)
	if err := service.SerBrowser.Save(&data); err != nil {
		e.Error(c, err)
		return
	}
	e.Ok(c, data)
...
// @Success 200 {object} base.Resp{data=models.Browser} "{"code": 200, "data": [...]}"
// @Router /api/sys/browser/del [post]
// @Security Bearer
