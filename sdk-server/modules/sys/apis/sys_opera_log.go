...
// @Router /api/sys/opera-log/page [post]
// @Security Bearer
...
// @Router /api/sys/opera-log/get [post]
// @Security Bearer
...
// @Success 200 {object} base.Resp{data=models.SysOperaLog} "{"code": 200, "data": [...]}"
// @Router /api/sys/opera-log/create [post]
// @Security Bearer
...
// @Param data body dto.SysOperaLogDto true "body"
// @Success 200 {object} base.Resp{data=models.SysOperaLog} "{"code": 200, "data": [...]}"
// @Router /api/sys/opera-log/update [post]
// @Security Bearer
...
// @Success 200 {object} base.Resp{data=models.SysOperaLog} "{"code": 200, "data": [...]}"
// @Router /api/sys/opera-log/del [post]
// @Security Bearer
