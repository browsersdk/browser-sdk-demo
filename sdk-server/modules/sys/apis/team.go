...
// @Success 200 {object} base.Resp{data=base.PageResp{list=[]dto.SysTeamData}} "{"code": 200, "data": [...]}"
// @Router /api/sys/team/page [post]
// @Security Bearer
...
// @Success 200 {object} base.Resp{data=models.SysTeam} "{"code": 200, "data": [...]}"
// @Router /api/sys/team/create [post]
// @Security Bearer
...
// @Param data body dto.SysTeamDto true "body"
// @Success 200 {object} base.Resp{data=models.SysTeam} "{"code": 200, "data": [...]}"
// @Router /api/sys/team/update [post]
// @Security Bearer
...
// @Param data body dto.SysTeamDto true "body"
// @Success 200 {object} base.Resp{data=models.SysTeam} "{"code": 200, "data": [...]}"
// @Router /api/sys/team/change [post]
// @Security Bearer
...
func (e *SysTeamApi) Del(c *gin.Context) {
	...
	if err := service.SerSysTeam.DelIds(req.Ids, admin); err != nil {
		e.Error(c, err)
		return
	}
	e.Ok(c)
