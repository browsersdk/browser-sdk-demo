...
// @Success 200 {object} base.Resp{data=models.SysCfg} "{"code": 200, "data": [...]}"
// @Router /api/sys/cfg/create [post]
// @Security Bearer
...
// @Param data body dto.SysCfgDto true "body"
// @Success 200 {object} base.Resp{data=models.SysCfg} "{"code": 200, "data": [...]}"
// @Router /api/sys/cfg/update [post]
// @Security Bearer
...
// // @Accept application/json
// // @Product application/json
// // @Param data body dto.TTSReq true "body"
// // @Success 200 {object} base.Resp{data=string} "{"code": 200, "data": [...]}"
// // @Router /api/v1/sys/tts [post]
// // @Security Bearer
// func (e *SysCfgApi) TTS(c *gin.Context) {
// 	var req dto.TTSReq
// 	if err := c.ShouldBind(&req); err != nil {
// 		e.Error(c, err)
// 		return
...
// 	str, err := service.SerSysCfg.TTS(&req)
// 	if err != nil {
// 		e.Error(c, err)
// 		return
// 	}
